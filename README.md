...
# Motor de descuentos temporales (Navidad 15%)

Este proyecto tiene un sistema simple de **descuento temporal** que se aplica
automáticamente a **todas las joyas** durante un período de tiempo definido.

Actualmente está configurado como **promo de Navidad 2025** con **15% de descuento**
entre el **8 y el 13 de diciembre de 2025**.
...
Contiene la lógica central del descuento:
